<template>
    <div class="szakkor-card animacio" style="animation-delay: 2s">
      ...
      <div v-else class="szakkor-nincs-tanulo">
        <span>Nincs beiratkozott gyerek.</span> <!-- Ha nincs beiratkozott gyerek, ezt jelenítjük meg -->
      </div>
    </div>
  </template>
  ...
  .led-separator {
    ...
    background: linear-gradient(90deg, #4c00ff, #00bfff, #4c00ff); /* LED-stílusú gradient háttér */
